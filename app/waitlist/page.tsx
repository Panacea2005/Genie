...
export default function WaitlistPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setIsSubmitted(true)
    // Reset after 2 seconds for demonstration
    setTimeout(() => {
    ...
    <main className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-6">
        <div className="flex flex-col items-center max-w-2xl w-full">
          ...
          >
            {/* Small gear icon above logo like in reference */}
            <motion.div 
              className="mb-2 z-10"
            ...
            <motion.h1 
              className="text-7xl font-normal mb-4 text-black z-10 logo-text"
            ...
            {/* Dot to right of logo */}
            <motion.div
              className="absolute right-1/3 top-1/2 h-2 w-2 rounded-full bg-gray-300"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <div className="relative flex flex-col items-center justify-center my-4 w-full mb-6">
              {/* 3D Gradient Sphere - Using the shared component */}
              <GradientSphere />
              
              <div className="absolute flex flex-col items-center max-w-lg w-full z-20" style={{ top: "calc(40% - 130px)" }}>
                {/* Text above email input - now positioned on the sphere */}
                <motion.p
                  className="text-center text-gray-600 mb-8 font-light"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ delay: 0.6 }}
                >
                ...
                {/* Email input positioned on the sphere */}
                <motion.form 
                ...
                >
                  <input
                    ...
                    className="flex-1 h-14 px-6 rounded-full border border-gray-200 bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-200 placeholder-gray-400 uppercase text-xs tracking-wider"
                    value={email}
                  ...
                  <motion.button
                    type="submit"
                    className="h-14 w-14 rounded-full bg-gray-500 text-white flex items-center justify-center"
